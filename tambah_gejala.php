                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="tile-body">
                    <form method="post" action="tambah_gejala_act.php" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="pull-left">Kode Gejala</label>
                            <input type="text" name="kode_gejala" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Pertanyaan</label>
                            <input class="form-control" type="text" name="pertanyaan">
                        </div>
